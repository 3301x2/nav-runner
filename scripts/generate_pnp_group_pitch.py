...
Multi-banner: all 8 PnP DESTINATIONs combined into one Group audience:
...
<p class='sub'>Distinct FNB cardholders who touched any {BRAND_NAME} banner — Market, Express, ASAP, Clothing, Liquor, Pharmacy, VAS, or Travel — in the last 12 months. A multi-format retail relationship, not just a supermarket footprint.</p>
{hero_kpis}
</div>
